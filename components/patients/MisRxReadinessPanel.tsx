    ...
    <div className="stack">
      ...
      {checks.length > 0 ? (
        <p className={ready ? 'alert success' : 'field-hint'}>
          {ready
            ? 'El borrador tiene los datos técnicos necesarios para una futura emisión. La emisión real sigue deshabilitada.'
            : 'Completá los puntos pendientes antes de intentar una emisión real.'}
        </p>
      ) : null}
    </div>
  );
