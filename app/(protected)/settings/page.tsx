...
import { updateSettings, disconnectGoogleCalendar, disconnectMercadoPago, saveArcaConnection, testArcaConnection } from './actions';
...
export default async function SettingsPage({ searchParams }: PageProps) {
  ...
  // Lectura server-only (service_role) — arca_connections no tiene policy
  // para 'authenticated', así que esto NO puede resolverse con el cliente
  // `supabase` normal de requireTenant(). getArcaConnectionSummary nunca
  // devuelve certificado/clave/token/sign, sólo los campos no-secretos que
  // esta pantalla necesita para mostrarse.
