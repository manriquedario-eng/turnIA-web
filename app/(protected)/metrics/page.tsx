...
export default async function MetricsPage() {
  ...
  return (
    <section className="stack">
      ...
      <div className="grid">
        <div className="card"><div className="muted">Saldo pendiente</div><strong style={{ fontSize: 28 }}>${totalDebt.toLocaleString('es-AR')}</strong></div>
        <div className="card"><div className="muted">Cobrado registrado</div><strong style={{ fontSize: 28 }}>${totalPaid.toLocaleString('es-AR')}</strong></div>
        <div className="card"><div className="muted">Tasa de cobranza</div><strong style={{ fontSize: 28 }}>{collectionRate.toFixed(1)}%</strong></div>
        <div className="card"><div className="muted">Ausentismo registrado</div><strong style={{ fontSize: 28 }}>{noShowRate.toFixed(1)}%</strong><div className="muted">{noShows} ausencias</div></div>
      </div>
      ...
      <div className="card">
        ...
        {debts.length === 0 ? <p className="muted">No hay saldos pendientes calculables.</p> : (
