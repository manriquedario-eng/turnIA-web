-- Correct public appointment action result semantics after staging validation.
-- Keeps pending reschedule cleanup while preserving newer already_cancelled behavior.
